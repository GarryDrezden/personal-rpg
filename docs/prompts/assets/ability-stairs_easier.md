# Asset: Легче подниматься по лестнице

## Purpose

Иконка Body Ability v1 — `BodyAbilityV1Card`, `BodyAbilityV1Section`, `BodyAbilityDashboardSummary`, `/growth/abilities`.
Заменит emoji fallback (`⬆️`) после генерации и UI wire. **Сейчас не in-app.**

## Body ability meaning

**Ability id:** `stairs_easier`  
**Category:** Выносливость (`endurance`)  
**Игровой смысл:** Endurance token — climbing stairs is less of a daily blocker
...
**Central subject:** Upward stone stairs with single warm step-light — climb feels lighter
...
- Category hint (muted): Выносливость
...
`public/game-assets/abilities/ability-endurance-stairs-up.webp`

## Manifest id

`ability-stairs_easier`
