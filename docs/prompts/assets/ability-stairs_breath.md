# Asset: Меньше одышки после лестницы

## Purpose

Иконка Body Ability v1 — `BodyAbilityV1Card`, `BodyAbilityV1Section`, `BodyAbilityDashboardSummary`, `/growth/abilities`.
Заменит emoji fallback (`🪜`) после генерации и UI wire. **Сейчас не in-app.**

## Body ability meaning

**Ability id:** `stairs_breath`  
**Category:** Выносливость (`endurance`)  
**Игровой смысл:** Endurance token — stairs feel calmer, breath recovers faster
...
**Central subject:** Stone staircase segment with calm breath wisps and ember trail light
...
`public/game-assets/abilities/ability-endurance-stairs.webp`

## Manifest id

`ability-stairs_breath`
