...
**Ability id:** `household_easier`  
**Category:** Быт (`dailyLife`)  
**Игровой смысл:** Daily life token — chores and home tasks without constant “cannot reach”
...
**Central subject:** Home hearth token: small broom, key, or lantern by doorway — domestic ritual
...
`public/game-assets/abilities/ability-daily-household.webp`

## Manifest id

`ability-household_easier`
