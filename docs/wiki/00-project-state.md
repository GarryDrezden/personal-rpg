...
1. Завершить male hero stages 4–18 по брендбуку
2. Обновлять manifest при каждой новой генерации
3. Подготовка accounts / registration / sync
4. Mobile navigation: Today в центре нижней панели
