...
| Следующий gameplay | Weekly season quests (опционально) или full boss art set |
| Visual later | Full boss art set (частичный wire уже в Boss Campaign v2) |
...
Full boss art set или weekly season quests (если понадобится отдельный слой поверх Week). HTTPS — infra на хостинге.
