...
| Следующий gameplay | **Seasons v2** — weekly quests, season rewards/artifacts, history |
...
**Seasons v2** (weekly quests, season reward/artifact, history) или полный boss art set. HTTPS — infra на хостинге.
