...
| Следующий visual | Chapter/act boss art (P2) — season mini-bosses S01–S13 уже in-app |
| Следующий gameplay | Weekly season quests (опционально) |
...
Full boss art set for season mini-bosses (S01–S13) is in-app. Next: chapter/act boss art (P2) or HTTPS on hosting.
