...
export const JOURNEY_STAGES: JourneyStage[] = [
  ...
  },
  {
    ...
    darkFantasyText: {
      title: 'База движения',
      description: 'Движение становится не случайностью, а частью системы персонажа.',
      completedText: 'База движения собрана. Путь держится на повторяемости.',
    },
  },
  {
    ...
    darkFantasyText: {
      title: 'Контроль режима',
      description: 'Режим начинает работать не только в хорошие дни, но и в обычную жизнь.',
      completedText: 'Контроль режима закреплён. У системы появился устойчивый контур.',
    },
  },
  {
    ...
    darkFantasyText: {
      title: 'Возврат выносливости',
      description: 'Тело получает больше регулярного движения и начинает выдерживать дистанцию.',
      completedText: 'Выносливость возвращается. Персонаж уже держит путь.',
    },
  },
  {
  ...
  },
  {
    ...
    darkFantasyText: {
      title: 'Новая мобильность',
      description: 'Путь уже достаточно длинный, чтобы изменения ощущались не только в цифрах.',
      completedText: 'Новая мобильность открыта. Персонаж прошёл большой участок возвращения тела.',
    },
  },
  {
