...
> = {
  ...
  momentum_set_direction: {
    cozy: {
      ...
      description: 'Инерция нейтральна. Начни с одного сигнала: шаги, ясность или отмеченный день.',
    },
    darkFantasy: {
      title: 'Направить путь',
      description: 'Ядро спокойно. Задай направление: шаги, ясность или отмеченный день.',
    },
  },
  momentum_keep_boost: {
    cozy: {
