        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-[var(--app-text-muted)]">
              Навыки, способности тела, лагерь, награды, коллекция трофеев, испытания недели и
              архив кампании боссов — слои долгой кампании. Ежедневный ход остаётся на экране
              «Сегодня».
            </p>
          </div>
        </div>
